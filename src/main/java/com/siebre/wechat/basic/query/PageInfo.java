package com.siebre.wechat.basic.query;
...
public class PageInfo implements Serializable {
	 ...
	 * 是否计算当前行
	 */
	private boolean calculateCurrentResult = Boolean.TRUE;
	...
	public PageInfo(int currentResult, int pageCount, Boolean calculateCurrentResult) {
		this.currentResult = currentResult;
		this.showCount = pageCount;
		this.calculateCurrentResult = calculateCurrentResult;
	}
	...
	public int getCurrentResult() {
		return this.calculateCurrentResult ? currentResult = (currentPage - 1) * showCount : this.currentResult;
	}
